...
units[1][1].fileNames = ['0.png', '1.png', '2.png', '3.png', '4.png'];
...
units[2][0].labels = ['FM Radio', 'USB', 'CD', 'AUX', 'FM Radio', 'USB', 'CD', 'AUX', 'FM Radio', 'USB', 'CD', 'AUX', ];
...
units[3][1].desc = 'Air Flow';
units[3][1].kind = 'text';
units[3][1].min = 0;
units[3][1].max = 7;
units[3][1].increment = 1;
units[3][1].unitSize = 80;
units[3][1].suffix = '';
units[3][1].now = 0;
units[3][1].last = 0;
units[3][1].decimals = 0;
units[3][1].labels = ['Off', 'Auto', '|', '||', '|||', '||||', '|||||', '||||||'];
...
units[4][0].desc = 'Seat Heating';
units[4][0].kind = 'text';
units[4][0].min = 0;
units[4][0].max = 3;
units[4][0].increment = 1;
units[4][0].unitSize = 200;
units[4][0].suffix = '';
units[4][0].now = 0;
units[4][0].last = 0;
units[4][0].decimals = 0;
units[4][0].labels = ['Off', 'Low', 'Med', 'High'];
